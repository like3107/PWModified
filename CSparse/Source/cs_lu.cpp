...
csn *cs_lu (const cs *A, const css *S, double tol)
{
    ...
    x = static_cast<double*>(cs_malloc (n, sizeof (double)) );            /* get double workspace */
    xi = static_cast<int*>(cs_malloc (2*n, sizeof (int)) );            /* get int workspace */
    N = static_cast<csn*>(cs_calloc (1, sizeof (csn)) );               /* alloacate result */
    ...
    N->pinv = pinv = static_cast<int*>(cs_malloc (n, sizeof (int)) );  /* allocate result pinv */
